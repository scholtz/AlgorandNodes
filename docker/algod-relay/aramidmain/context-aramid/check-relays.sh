...
# Set the DNS name
dns_name1="_algobootstrap._tcp.aramidmain.a-wallet.net"
dns_name2="_archive._tcp.aramidmain.a-wallet.net"
statusURL="https://algod.aramidmain.a-wallet.net/v2/status"
