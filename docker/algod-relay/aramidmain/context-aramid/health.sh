...
# curl http://localhost:18280/v2/blocks/1 -H "X-Algo-API-Token: c8ce54bf3954e56393f0a327675bf96655f946734503041e5750081f83145ac9" -H 'accept: application/json' --output x.tmp
# curl http://localhost:18280/v2/blocks/0?format=json -H "x-algo-api-token: aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa | sha256sum = ab0e1d776be96d2f0b991ba836339262759943d25ca414cbb50fe796420e1684 -- ARAMID
